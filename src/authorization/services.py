...
from users.repositories import UserRepositoryService, UserModel
...
async def authenticate_user(login: str, password: str, user_service: UserRepositoryService) -> UserModel:
